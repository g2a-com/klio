...
// Load reads, parses and validates specified configuration file
func Load(dataStruct interface{}, meta *Metadata, configFilePath string) error {
...
// Save validates, serializes and saves configuration to a file
func Save(data interface{}, configFilePath string) error {
